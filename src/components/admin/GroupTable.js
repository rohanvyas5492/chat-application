...
const UserTable = ({heading}) => {
  ...
  <div className="row row--top-40">
    <div className="col-md-12" style={{display:'flex',justifyContent:'space-between'}}>
      ...
      <button className="register-btn btn btn-primary" onClick={()=>navigate('../create-group')}>Add Group</button>
    </div>
  </div>
        ...
        <table className="table">
          <thead className="table__thead">
            <tr>
              ...
              <th className="table__th">Group Admin</th>
            ...
            <tr className="table-row table-row--chris">
              ...
              <td className="table-row__td">
                ...
                <div className="table-row__info">
                  <p className="table-row__name">Friends Group</p>
                </div>
              </td>
